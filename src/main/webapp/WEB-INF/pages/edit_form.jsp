...
<h1 style="color: green; text-align: center">Student Edit Form</h1>
<form action="edit" method="post">
	<table align="center" border="2" cellpadding="5" cellspacing="5">
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" value="UPDATE"/>&nbsp;<input type="button" value="BACK" onclick="history.back()"/> </td>
		</tr>
	</table>
</form>